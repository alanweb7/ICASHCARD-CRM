...
<script src="<?= $module_assets_url; ?>icash_tools_atendentes_functions_js.js?ver=7.7.11"></script>
<style>
    .button_send {
        float: right;
    }
                                        ...
                                        <td>
                                            ...
                                            <?php if (is_admin()): ?>
                                                ...
                                                <button
                                                    ...
                                                    onclick="deleteStaff(<?= (int) $staff['staffid'] ?>)"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="staffEmail" name="email" value="" required>
                </div>
                <div class="form-group">
                    <label for="fullname">Nome</label>
                    <input type="text" class="form-control" id="staffFullname" name="fullname" value="" required>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="phone"><?php echo _l('Telefone'); ?></label>
                            <input type="text" id="staffphone" name="phone" value="" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label for="cpf"><?php echo _l('CPF'); ?></label>
                            <input type="text" id="staffcpf" name="cpf" value="" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
